...
static void lcd_laser_test_fire_menu() {
	...
	MENU_ITEM(function, " 20% 300ms", action_laser_test_20_50ms);
	MENU_ITEM(function, " 20% 500ms", action_laser_test_20_100ms);
	MENU_ITEM(function, "100% 300ms", action_laser_test_100_50ms);
	MENU_ITEM(function, "100% 500ms", action_laser_test_100_100ms);
	MENU_ITEM(function, "Warm-up Laser 1sec", action_laser_test_warm);
	END_MENU();
}
...
static void action_laser_test_20_50ms() {
	laser_test_fire(20, 300);
}

static void action_laser_test_20_100ms() {
	laser_test_fire(20, 500);
}

static void action_laser_test_100_50ms() {
	laser_test_fire(100, 300);
}

static void action_laser_test_100_100ms() {
	laser_test_fire(100, 500);
}

static void action_laser_test_warm() {
	laser_test_fire(100, 1000);
}
