...
// AMRI Laser Cutter
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {34, 34, 34, 34}
//#define DEFAULT_MAX_FEEDRATE          {30, 30, 30, 30}    // (mm/sec)    
//#define DEFAULT_MAX_ACCELERATION      {30,30,30,10}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
//#define DEFAULT_ACCELERATION          10    // X, Y, Z and E max acceleration in mm/s^2 for printing moves 
//#define DEFAULT_RETRACT_ACCELERATION  10   // X, Y, Z and E max acceleration in mm/s^2 for r retracts

// Lansing Makers Netowork Laser Cutter
#define DEFAULT_AXIS_STEPS_PER_UNIT   {34, 34, 34, 34}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {30, 30, 30, 30}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {30,30,30,10}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
